document.addEventListener('DOMContentLoaded', () => {
    ...
    function joinTable(tableId) {
        ...
        listenForChat();
        joinVoiceChannel(tableId, localPlayerId); // Join voice channel
    }
    ...
    function updateActionButtons(state, myPlayer) {
        ...
        if (isMyTurn) {
            ...
            ui.actionButtons.show.disabled = (activePlayersCount > 2) ? true : false;
    ...
    ui.themeBtn.onclick = () => { /* Logic for theme popup */ };
